...
onMounted(() => {
  if (props.toolbarRef && dropDownRef.value) {
    const { top, left, width, height } = props.toolbarRef.getBoundingClientRect();
...
<template>
  <div ref="dropDownRef" class="dropdown" style="z-index: 9999">
    <div class="colorContainer">
      ...
      ></div>
      <div style="width: 100%; height: 1px; background-color: #d4d4d8; margin-top: 4px; margin-bottom: 4px"></div>
      <div
    ...
    <div style="width: 100%; height: 1px; background-color: #d4d4d8; margin-top: 4px; margin-bottom: 4px"></div>
    <div class="colorItemText" :style="`background-color: ${colorValue};`"></div>
  </div>
</template>
